...
const textNodes = [
    ...
    {
        id: 2,
        text: 'you venture forth in search of answers to here you are when you come acrross a marchant .',
        options: [
            {
        ...
        id: 3,
        text: 'sfter leaving the merchant you start to feel tired ant stond upon a small town next to a dangerous looking castle.',
        options: [
            {
